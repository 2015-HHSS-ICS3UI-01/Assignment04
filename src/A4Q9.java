...
// new variables called Location and  square , making both equal the zero 
        ...
        while (true) {
            ...
            //"Location" now equals itself plus sum amount
...
//if sum is less than or equal to 13, the following commands will occur
            ...
            if (Location == 40) //tell uuser they climed a ladder
            {
            ...
            if (rolldice <= 1) {
                //tell player 2 they quit and player 2 wins 
            ...
            //if Location is equal to 9, tell user they climed a ladder and there new space 
            if (square == 9) {
            ...
            //if Location is equal to 40, tell user they climed a ladder and there new space 
            if (square == 40) {
            ...
            //if Location is equal to 67, tell user they climed a ladder and there new space 
            if (square == 67) {
                //makes the computer display "You climbed a ladder to Location 86!" on the screen
            ...
            if (square == 90) {
                ////tell the user a snake ate them and there new space is 48
            ...
            if (square == 99) {
                ////tell the user a snake ate them and there new space is 77
